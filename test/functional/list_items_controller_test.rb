...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { description: @list_item.description, list_id: @list_item.list_id, venue_id: @list_item.venue_id }
    end
  ...
  test "should update list_item" do
    put :update, id: @list_item, list_item: { description: @list_item.description, list_id: @list_item.list_id, venue_id: @list_item.venue_id }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
